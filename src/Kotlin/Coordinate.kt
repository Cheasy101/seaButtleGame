...
internal class Coordinate {
    ...
    fun Coordinates(line: String?): IntArray {
        //должны совпадать либо буквы, либо цифры, чтобы корабль был либо вертикально, либо горизонтально

        var firstLetter = 0
        var secondLetter = 0 //начало и конец корабля
        var firstNumber = 0
        var secondNumber = 0
        val regex = "([A-J])(\\d+)([A-J])(\\d+)"
        //чтобы было буква-число, буква-число
